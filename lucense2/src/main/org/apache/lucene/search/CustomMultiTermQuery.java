...
public abstract class CustomMultiTermQuery extends CustomQuery {
  ...
  private int pos;
  private TermDocsFactory tdf;

  /** Abstract class that defines how the query is rewritten. */
  public static abstract class RewriteMethod implements Serializable {
    public abstract Query rewrite(IndexReader reader, CustomMultiTermQuery query, int pos, TermDocsFactory tdf) throws IOException;
    
    /**
     * Returns the {@link MultiTermQuery}s {@link FilteredTermEnum}
     * @see MultiTermQuery#getEnum(IndexReader)
     */
    protected FilteredTermEnum getTermsEnum(IndexReader reader, CustomMultiTermQuery query) throws IOException {
  ...
  public static final RewriteMethod CONSTANT_SCORE_FILTER_REWRITE = new RewriteMethod() {
    @Override
    public Query rewrite(IndexReader reader, CustomMultiTermQuery query, int pos, TermDocsFactory tdf) {
      Query result = new CustomConstantScoreQuery(new CustomMultiTermQueryWrapperFilter<CustomMultiTermQuery>(query));
   ...
   *
   *  @see #setRewriteMethod */
  public final static RewriteMethod SCORING_BOOLEAN_QUERY_REWRITE = CustomScoringRewrite.SCORING_BOOLEAN_QUERY_REWRITE;
   ...
   *
   *  @see #setRewriteMethod */
  public final static RewriteMethod CONSTANT_SCORE_BOOLEAN_QUERY_REWRITE = CustomScoringRewrite.CONSTANT_SCORE_BOOLEAN_QUERY_REWRITE;
   ...
   * @see #setRewriteMethod
   */
  public static final class TopTermsScoringBooleanQueryRewrite extends CustomTopTermsRewrite<CustomBooleanQuery> {
    ...
    @Override
    protected CustomBooleanQuery getTopLevelQuery() {
      return new CustomBooleanQuery(true);
    }
    
    @Override
    protected void addClause(CustomBooleanQuery topLevel, Term term, float boost, int pos, TermDocsFactory tdf) {
      final CustomTermQuery tq = new CustomTermQuery(term, pos, tdf);
      tq.setBoost(boost);
   ...
   * @see #setRewriteMethod
   */
  public static final class TopTermsBoostOnlyBooleanQueryRewrite extends CustomTopTermsRewrite<BooleanQuery> {
    ...
    @Override
    protected void addClause(BooleanQuery topLevel, Term term, float boost, int pos, TermDocsFactory tdf) {
      final Query q = new CustomConstantScoreQuery(new CustomTermQuery(term, pos, tdf));
      q.setBoost(boost);
   ...
   *  used.
   */
  public static class ConstantScoreAutoRewrite extends org.apache.lucene.search.CustomConstantScoreAutoRewrite {}

  /** Read-only default instance of {@link
   *  CustomConstantScoreAutoRewrite}, with {@link
   *  CustomConstantScoreAutoRewrite#setTermCountCutoff} set to
   *  {@link
   *  CustomConstantScoreAutoRewrite#DEFAULT_TERM_COUNT_CUTOFF}
   *  and {@link
   *  CustomConstantScoreAutoRewrite#setDocCountPercent} set to
   *  {@link
   *  CustomConstantScoreAutoRewrite#DEFAULT_DOC_COUNT_PERCENT}.
   *  Note that you cannot alter the configuration of this
   *  instance; you'll need to create a private instance
   *  instead. */
  public final static RewriteMethod CONSTANT_SCORE_AUTO_REWRITE_DEFAULT = new CustomConstantScoreAutoRewrite() {
    @Override
   ...
   * Term.
   */
  public CustomMultiTermQuery(int pos, TermDocsFactory tdf) {
    this.pos = pos;
    this.tdf = tdf;
  }
  ...
  public final Query rewrite(IndexReader reader) throws IOException {
    return rewriteMethod.rewrite(reader, this, pos, tdf);
  }
