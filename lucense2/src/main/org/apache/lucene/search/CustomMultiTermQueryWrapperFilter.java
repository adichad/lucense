 ...
 * <P>
 * <code>CustomMultiTermQueryWrapperFilter</code> is not designed to
 * be used by itself. Normally you subclass it to provide a Filter
 * counterpart for a {@link MultiTermQuery} subclass.
 * <P>
 * For example, {@link TermRangeFilter} and {@link PrefixFilter} extend
 * <code>CustomMultiTermQueryWrapperFilter</code>.
 * This class also provides the functionality behind
 * {@link MultiTermQuery#CONSTANT_SCORE_FILTER_REWRITE};
 * this is why it is not abstract.
 */
public class CustomMultiTermQueryWrapperFilter<Q extends CustomMultiTermQuery> extends Filter {
   ...
   */
  protected CustomMultiTermQueryWrapperFilter(Q query) {
      this.query = query;
  }
