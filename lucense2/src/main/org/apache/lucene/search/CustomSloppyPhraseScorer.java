...
final class CustomSloppyPhraseScorer extends CustomPhraseScorer {
  ...
  CustomSloppyPhraseScorer(Weight weight, CustomPhraseQuery.PostingsAndFreq[] postings, CustomPhraseQuery.PostingsAndFreq[] cpostings, Similarity similarity,
      int slop, byte[] norms) throws IOException {
    super(weight, postings, cpostings, similarity, norms);
    this.slop = slop;
