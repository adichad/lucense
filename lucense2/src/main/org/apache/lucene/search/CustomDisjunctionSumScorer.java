...
class CustomDisjunctionSumScorer extends CustomScorer {
   ...
   */
  public CustomDisjunctionSumScorer(List<Scorer> subScorers, int minimumNrMatchers) throws IOException {
    super(null);
   ...
   */
  public CustomDisjunctionSumScorer(List<Scorer> subScorers) throws IOException {
    this(subScorers, 1);
  }
  ...
  private void initScorerDocQueue() throws IOException {
    Iterator<Scorer> si = this.subScorers.iterator();
