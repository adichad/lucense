...
final class CustomBooleanScorer extends CustomScorer {
  ...
  static final class SubScorer {
    ...
    public void matchedTermPositions(Map<String, MatchTermPositions> mtp, Set<String> scoreFields) throws IOException {
      if(this.scorer instanceof CustomScorer)
  ...
  CustomBooleanScorer(Similarity similarity, int minNrShouldMatch, List<Scorer> optionalScorers,
      List<Scorer> prohibitedScorers, float boost) throws IOException {
    super(similarity);
    this.boost = boost;
