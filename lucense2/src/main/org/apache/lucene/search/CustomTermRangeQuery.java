...
public class CustomTermRangeQuery extends CustomMultiTermQuery {
  ...
  public CustomTermRangeQuery(String field, String lowerTerm, String upperTerm, boolean includeLower,
      boolean includeUpper, int qpos, TermDocsFactory tdf) {
    this(field, lowerTerm, upperTerm, includeLower, includeUpper, null, qpos, tdf);
  }
   ...
   */
  public CustomTermRangeQuery(String field, String lowerTerm, String upperTerm, boolean includeLower,
      boolean includeUpper, Collator collator, int qpos, TermDocsFactory tdf) {
    super(qpos, tdf);
    this.field = field;
