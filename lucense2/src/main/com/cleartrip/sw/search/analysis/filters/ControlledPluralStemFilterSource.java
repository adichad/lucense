...
import com.cleartrip.sw.search.analysis.filters.stem.ControlledPluralStemFilter;
import com.cleartrip.sw.search.util.Constants;

public class ControlledPluralStemFilterSource extends TokenFilterSource {
  ...
  public ControlledPluralStemFilterSource(Map<String, ?> params, Properties env)
      throws Exception {
    super(params, env);
  ...
  public TokenStream getTokenStream(TokenStream tokenStream) {
    return new ControlledPluralStemFilter(tokenStream, this.blackList,
