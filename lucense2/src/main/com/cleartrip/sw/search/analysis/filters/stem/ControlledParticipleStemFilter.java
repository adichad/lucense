...
public class ControlledParticipleStemFilter extends TokenFilter {
  private ControlledParticipleStemmer stemmer;
  ...
  public ControlledParticipleStemFilter(TokenStream input) {
    super(input);
    this.stemmer = new ControlledParticipleStemmer();
  ...
  public ControlledParticipleStemFilter(TokenStream input, Set<String> blackList, boolean markStem) {
    super(input);
    this.stemmer = new ControlledParticipleStemmer(blackList);
    this.termAtt = addAttribute(CharTermAttribute.class);
    this.posAtt = addAttribute(PositionIncrementAttribute.class);
    this.payAtt = addAttribute(PayloadAttribute.class);
    this.replaceFlag = true;
  ...
  public ControlledParticipleStemFilter(TokenStream input, Set<String> blackList, int minLen, boolean replace,
      boolean markStem) {
    super(input);
    this.stemmer = new ControlledParticipleStemmer(blackList, minLen);
    this.termAtt = addAttribute(CharTermAttribute.class);
    this.posAtt = addAttribute(PositionIncrementAttribute.class);
    this.payAtt = addAttribute(PayloadAttribute.class);
