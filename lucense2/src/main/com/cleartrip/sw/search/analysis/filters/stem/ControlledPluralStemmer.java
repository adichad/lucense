...
public class ControlledPluralStemmer {
  private char[] b;
  ...
  public ControlledPluralStemmer() {
    this.b = new char[INC];
    this.i = 0;
  ...
  public ControlledPluralStemmer(Set<String> blackList) {
    this();
    if (blackList != null) {
  ...
  public ControlledPluralStemmer(Set<String> blackList, int minLen) {
    this(blackList);
    this.minLen = minLen;
  }

  public ControlledPluralStemmer(int minLen) {
    this();
    this.minLen = minLen;
  }
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ControlledPluralStemmer s = new ControlledPluralStemmer(exclude, 4);
