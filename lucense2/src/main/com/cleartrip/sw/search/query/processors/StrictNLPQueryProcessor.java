...
public class StrictNLPQueryProcessor extends QueryProcessor {

  // private final POSModel posModel;

  public StrictNLPQueryProcessor(Map<String, QueryParserFactory> myParsers,
  ...
  public SearchResult process(SearchParameters params, IndexSearcher searcher,
    ...
    if (searchResult.getTotalCount() == 0) {
      StrictNLPSearchParameters searchParams = (StrictNLPSearchParameters) params;
      String[] qparts;
      if ((qparts = searchParams.queryString
        ...
        searchResult = doSearch(searchParams, searcher, log);
      }
    }
    ...
    try {
      ...
      if (searchParams.multiSearch) {
        ...
        if (qparts.length <= 1) {
          ...
          StrictNLPSearchParameters restrictedParams = (StrictNLPSearchParameters) restrict(
              searchParams, true);
      ...
      if (faceters != null && searchParams.enableFacets) {
        ...
        for (String faceterName : searchParams.facets) {
          ...
          c = faceter
              ...
              .setTFC(tfc, searcher.getIndexReader(), nameDocId)
      ...
      if (this.faceters != null && searchParams.enableFacets) {
        ...
        for (String facetName : faceterMap.keySet()) {
          sb.append("\"").append(facetName).append("\":")
              .append(faceterMap.get(facetName).getFacetJson(searcher,new FacetsJsonTopDocs(tfd)))
              .append(",");
        }
        sb.deleteCharAt(sb.length() - 1).append("}");
      }
...
//      }
  ...
  public static class StrictNLPSearchParameters extends SearchParameters {
    ...
    public StrictNLPSearchParameters() {
      fields.add("name");
      fields.add("aliases");
    ...
    public SearchParameters clone() {
      StrictNLPSearchParameters sp = new StrictNLPSearchParameters();
  ...
  public SearchParameters createSearchParams(Map<String, String[]> params,
      Reader reader) {
    StrictNLPSearchParameters searchParams = new StrictNLPSearchParameters();
  ...
  private SearchParameters restrict(SearchParameters params) {
    StrictNLPSearchParameters nlpsp = (StrictNLPSearchParameters) params
        .clone();
  ...
  public Query createQuery(SearchParameters params) throws ParseException,
      IOException {
    return ((StrictNLPSearchParameters) params).parser.parse(params);
  }
