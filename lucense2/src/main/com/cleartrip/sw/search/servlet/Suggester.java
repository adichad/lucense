 ...
 */
@WebServlet(description = "Suggest API", urlPatterns = { "/suggest/*" })
public class Suggester extends HttpServlet {
  private static final long               serialVersionUID = 1L;
  private static final Logger             log              = LoggerFactory
                                                               .getLogger(Suggester.class);
  ...
  protected final void doGet(HttpServletRequest request,
    ...
    try {
      ...
      try {
        ...
        SuggestResult result = ((DataManager) request
            .getAttribute(Constants.DATA_MANAGER_KEY)).suggest(paramMap,
            reader, innerLog);
