 ...
 */
@WebServlet(description = "Data Analysis API", urlPatterns = { "/analyze/*" })
  ...
  protected final void doGet(HttpServletRequest request,
    ...
    try {
      ...
      try {
        ...
        AnalyzeResult result = ((DataManager) request
            .getAttribute(Constants.DATA_MANAGER_KEY)).analyze(paramMap,
            reader, innerLog);
