...
public class DoubleExpressionCollector extends ExpressionCollector {

  protected DoubleLucenseExpression expr;

  protected Int2DoubleArrayMap vals = new Int2DoubleArrayMap();
  ...
  public DoubleExpressionCollector(DoubleLucenseExpression expr, Collector c, Context cx) throws IOException {
    super(c);
    this.expr = expr;
