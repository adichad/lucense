...
final public class IntAggregatorSum implements AggregatorExpressionNode, IntExpressionNode {
  private final IntExpressionNode child;

  public IntAggregatorSum(IntExpressionNode child) {
    this.child = child;
  }

  @Override
  final public int evaluate(Slates slates, Context cx) {
    int i = slates.slateInt.getInt(this);
