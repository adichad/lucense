...
public class IntExpressionCollector extends ExpressionCollector {
  ...
  protected Int2IntOpenHashMap vals = new Int2IntOpenHashMap();
  ...
  public IntExpressionCollector(IntLucenseExpression expr, Collector c, Context cx) throws IOException {
    super(c);
    this.expr = expr;
