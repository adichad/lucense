...
public class ControlledPluralsStemFilter extends TokenFilter {
  private ControlledPluralsStemmer stemmer;
  ...
  public ControlledPluralsStemFilter(TokenStream input) {
    super(input);
    this.stemmer = new ControlledPluralsStemmer();
  ...
  public ControlledPluralsStemFilter(TokenStream input, Set<String> blackList, boolean markStem) {
    super(input);
    this.stemmer = new ControlledPluralsStemmer(blackList);
    this.termAtt = addAttribute(CharTermAttribute.class);
    this.posAtt = addAttribute(PositionIncrementAttribute.class);
    this.payAtt = addAttribute(PayloadAttribute.class);
    this.replaceFlag = true;
  ...
  public ControlledPluralsStemFilter(TokenStream input, Set<String> blackList, int minLen, boolean replace,
      boolean markStem) {
    super(input);
    this.stemmer = new ControlledPluralsStemmer(blackList, minLen);
    this.termAtt = addAttribute(CharTermAttribute.class);
    this.posAtt = addAttribute(PositionIncrementAttribute.class);
    this.payAtt = addAttribute(PayloadAttribute.class);
