...
public class ControlledPresentParticipleInvertingStemFilter extends TokenFilter {
  private ControlledPresentParticipleInvertingStemmer stemmer;
  ...
  public ControlledPresentParticipleInvertingStemFilter(TokenStream input) {
    super(input);
    this.invAtt = addAttribute(StemInversionAttribute.class);
    this.stemmer = new ControlledPresentParticipleInvertingStemmer(this.invAtt);
  ...
  public ControlledPresentParticipleInvertingStemFilter(TokenStream input, Set<String> blackList) {
    super(input);
    this.invAtt = addAttribute(StemInversionAttribute.class);
    this.stemmer = new ControlledPresentParticipleInvertingStemmer(blackList, this.invAtt);
    this.termAtt = addAttribute(CharTermAttribute.class);
    this.posAtt = addAttribute(PositionIncrementAttribute.class);
    this.replaceFlag = true;
    this.writeStem = false;
  ...
  public ControlledPresentParticipleInvertingStemFilter(TokenStream input, Set<String> blackList, int minLen,
      boolean replace) {
    super(input);
    this.invAtt = addAttribute(StemInversionAttribute.class);
    this.stemmer = new ControlledPresentParticipleInvertingStemmer(blackList, minLen, this.invAtt);
    this.termAtt = addAttribute(CharTermAttribute.class);
    this.posAtt = addAttribute(PositionIncrementAttribute.class);
