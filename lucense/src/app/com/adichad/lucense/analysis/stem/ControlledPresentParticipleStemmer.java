...
public class ControlledPresentParticipleStemmer {
  private char[] b;
  ...
  public ControlledPresentParticipleStemmer() {
    this.b = new char[INC];
    this.i = 0;
  ...
  public ControlledPresentParticipleStemmer(Set<String> blackList) {
    this();
    if (blackList != null) {
  ...
  public ControlledPresentParticipleStemmer(Set<String> blackList, int minLen) {
    this(blackList);
    this.minLen = minLen;
  }

  public ControlledPresentParticipleStemmer(int minLen) {
    this();
    this.minLen = minLen;
  }
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      ControlledPresentParticipleStemmer s = new ControlledPresentParticipleStemmer(exclude, 4);
