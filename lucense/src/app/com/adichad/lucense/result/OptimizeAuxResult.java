...
public class OptimizeAuxResult implements Result {
  ...
  public OptimizeAuxResult(int id, BitMapOperationStatus os, byte commandType) {
    this.reqId = id;
    this.os = os;
  ...
  public void writeTo(OutputStream out) throws IOException {
    ...
    dos.writeByte(this.os != BitMapOperationStatus.SUCCESS ? 0 : 1);
  }
