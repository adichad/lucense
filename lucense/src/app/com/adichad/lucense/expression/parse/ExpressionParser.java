...
public class ExpressionParser implements ExpressionParserConstants {
  ...
  final public ExpressionTree parse(Context cx, Scriptable scope) throws ParseException {
  this.cx = cx;
  this.scope = scope;
    if (jj_2_1(10000)) {
      boolexpression();
  ...
  Token t;
    ...
    } else if (jj_2_6(10000)) {
      t = jj_consume_token(ID);
      jj_consume_token(ASSIGNMENT);
      intexpression();
    IntExpressionNode root = (IntExpressionNode) operands.pop();
    intvars.put(t.toString(), root);
    } else if (jj_2_7(10000)) {
      t = jj_consume_token(ID);
      jj_consume_token(ASSIGNMENT);
      stringexpression();
    StringExpressionNode root = (StringExpressionNode) operands.pop();
    stringvars.put(t.toString(), root);
    } else if (jj_2_8(10000)) {
      t = jj_consume_token(ID);
      jj_consume_token(ASSIGNMENT);
      stringexpression();
    FloatExpressionNode root = (FloatExpressionNode) operands.pop();
  ...
  final public void intexpression() throws ParseException {
    if (jj_2_16(10000)) {
      ...
      intbinaryoperator();
      intexpression();
    } else if (jj_2_17(10000)) {
      intunaryoperator();
      intexpression();
    } else if (jj_2_18(10000)) {
      lb();
      intexpression();
      rb();
      if (jj_2_15(10000)) {
  ...
  final public void boolexpression() throws ParseException {
    if (jj_2_21(10000)) {
      ...
      boolbinaryoperator();
      boolexpression();
    } else if (jj_2_22(10000)) {
      boolunaryoperator();
      boolexpression();
    } else if (jj_2_23(10000)) {
      lb();
      boolexpression();
      rb();
      if (jj_2_20(10000)) {
...
///////////////////////////////////////////////////////////////
  ...
  final public void boolauxfilter() throws ParseException {
    jj_consume_token(AUXFILTER);
    lb();
    stringliteral();
    comma();
    stringliteral();
  ...
  final public void floatbinaryoperator() throws ParseException {
    ...
    } else if (jj_2_57(10000)) {
      jj_consume_token(SUB);
      procOp(Operator.FLOATSUB);
    } else if (jj_2_58(10000)) {
      jj_consume_token(MUL);
      procOp(Operator.FLOATMUL);
    } else if (jj_2_59(10000)) {
      jj_consume_token(DIV);
  ...
  Token t;
    if (jj_2_60(10000)) {
      stringconcat();
    } else if (jj_2_61(10000)) {
      stringconcatws();
    } else if (jj_2_62(10000)) {
      stringaggconcat();
    } else if (jj_2_63(10000)) {
      stringaggconcatws();
    } else if (jj_2_64(10000)) {
      stringaggconcatwsext();
    } else if (jj_2_65(10000)) {
      stringaggconcatfsps();
    } else if (jj_2_66(10000)) {
      stringif();
    } else if (jj_2_67(10000)) {
      stringjsexpression();
    } else if (jj_2_68(10000)) {
      stringlatejsexpression();
    } else if (jj_2_69(10000)) {
  ...
  Token t;
    if (jj_2_73(10000)) {
      floatif();
    } else if (jj_2_74(10000)) {
      floatmax();
    } else if (jj_2_75(10000)) {
      floatmin();
    } else if (jj_2_76(10000)) {
      floatjsexpression();
    } else if (jj_2_77(10000)) {
      floatlatejsexpression();
    } else if (jj_2_78(10000)) {
      floataggsum();
    } else if (jj_2_79(10000)) {
      floataggmax();
    } else if (jj_2_80(10000)) {
      floataggmin();
    } else if (jj_2_81(10000)) {
      floataggproduct();
    } else if (jj_2_82(10000)) {
      jj_consume_token(FLOATTYPE);
      t = jj_consume_token(ID);
  ...
  Token t;
    if (jj_2_84(10000)) {
      intif();
    } else if (jj_2_85(10000)) {
      intmax();
    } else if (jj_2_86(10000)) {
      intmin();
    } else if (jj_2_87(10000)) {
      intjsexpression();
    } else if (jj_2_88(10000)) {
      intlatejsexpression();
    } else if (jj_2_89(10000)) {
      intaggsum();
    } else if (jj_2_90(10000)) {
      intaggmax();
    } else if (jj_2_91(10000)) {
      intaggmin();
    } else if (jj_2_92(10000)) {
      intaggbitand();
    } else if (jj_2_93(10000)) {
      intaggbitor();
    } else if (jj_2_94(10000)) {
      intaggproduct();
    } else if (jj_2_95(10000)) {
      intstringlength();
    } else if (jj_2_96(10000)) {
      jj_consume_token(INTTYPE);
      t = jj_consume_token(ID);
  ...
  Token t;
    if (jj_2_98(10000)) {
      boolif();
    } else if (jj_2_99(10000)) {
      boolauxfilter();
    } else if (jj_2_100(10000)) {
      booljsexpression();
    } else if (jj_2_101(10000)) {
      boollatejsexpression();
    } else if (jj_2_102(10000)) {
      intexpression();
      intcompare();
      intexpression();
    } else if (jj_2_103(10000)) {
      stringexpression();
      stringcompare();
      stringexpression();
    } else if (jj_2_104(10000)) {
  ...
  private boolean jj_3R_65() {
    if (jj_scan_token(AUXFILTER)) return true;
    if (jj_3R_20()) return true;
    if (jj_3R_41()) return true;
    if (jj_3R_30()) return true;
    if (jj_3R_41()) return true;
