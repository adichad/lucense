...
public class IntMinus implements IntExpressionNode {
  private IntExpressionNode positiveChild;

  private List<IntExpressionNode> negativeChildren;

  public IntMinus(IntExpressionNode positiveChild, List<IntExpressionNode> negativeChildren) {
  ...
  public int evaluate(VarContext context, Map<AggregatorExpressionNode, Object> slateObject,
    ...
    int i = this.positiveChild.evaluate(context, slateObject, slateInt, slateFloat, slateDouble, slateBoolean);
  ...
  public int evaluateFinal(Map<AggregatorExpressionNode, Object> slateObject,
      ...
      Object2DoubleOpenHashMap<AggregatorExpressionNode> slateDouble,
      Object2BooleanOpenHashMap<AggregatorExpressionNode> slateBoolean) {
    int i = this.positiveChild.evaluateFinal(slateObject, slateInt, slateFloat, slateDouble, slateBoolean);
    for (IntExpressionNode child : this.negativeChildren) {
