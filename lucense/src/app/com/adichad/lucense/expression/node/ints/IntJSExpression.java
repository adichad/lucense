...
public class IntJSExpression extends JSExpression implements IntExpressionNode {
  public IntJSExpression(StringLiteral exprNode, Context cx, Scriptable scope, Map<String, IntExpressionNode> intvars,
  ...
  public int evaluate(VarContext context, Map<AggregatorExpressionNode, Object> slateObject,
    ...
    return ((Double) Context.toNumber(this.script.exec(this.cx, this.scope))).intValue();
  }
