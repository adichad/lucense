...
public class BooleanJSExpressionLate extends JSExpressionLate implements BooleanExpressionNode {

  public BooleanJSExpressionLate(StringLiteral exprNode, Context cx, Scriptable scope,
  ...
  public boolean evaluateFinal(Map<AggregatorExpressionNode, Object> slateObject,
    ...
    return Context.toBoolean(this.script.exec(this.cx, (Scriptable) slateObject.get(this)));
  }
