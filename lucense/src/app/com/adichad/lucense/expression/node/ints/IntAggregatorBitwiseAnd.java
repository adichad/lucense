...
public class IntAggregatorBitwiseAnd implements AggregatorExpressionNode, IntExpressionNode {
  IntExpressionNode child;

  public IntAggregatorBitwiseAnd(IntExpressionNode child) {
    this.child = child;
  }
