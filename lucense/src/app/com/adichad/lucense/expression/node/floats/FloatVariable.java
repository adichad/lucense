...
public class FloatVariable implements AggregatorExpressionNode, FloatExpressionNode, Variable {
  String name;
  ...
  public float evaluate(VarContext context, Map<AggregatorExpressionNode, Object> slateObject,
    ...
    return context.floatVals.get(this.name);
  }
