...
public class FloatJSExpressionLate extends JSExpressionLate implements FloatExpressionNode {

  public FloatJSExpressionLate(StringLiteral exprNode, Context cx, Scriptable scope,
  ...
  public float evaluateFinal(Map<AggregatorExpressionNode, Object> slateObject,
    ...
    return ((Double) Context.toNumber(this.script.exec(this.cx, (Scriptable) slateObject.get(this)))).floatValue();
  }
