...
public class LCSLengthComparatorSource extends FieldComparatorSource {

  private static final long serialVersionUID = 1L;

  public class LCSLengthComparator extends FieldComparator<Integer> {
    ...
    public LCSLengthComparator(String fieldname, int numHits) throws IOException {
    ...
    public int compareBottom(int doc) {
      ...
      try {
        nmap = this.scorer.lcsLength(ValueSourceFactory.scoreFields);
      } catch (Exception e) {
  ...
  public FieldComparator<Integer> newComparator(String fieldname, int numHits, int sortPos, boolean reversed)
      throws IOException {
    return new LCSLengthComparator(fieldname, numHits);
  }
