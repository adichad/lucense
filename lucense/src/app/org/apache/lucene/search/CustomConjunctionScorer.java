...
class CustomConjunctionScorer extends CustomScorer {
  ...
  public CustomConjunctionScorer(Similarity similarity, Collection<CustomScorer> scorers) throws IOException {
    this(similarity, scorers.toArray(new CustomScorer[scorers.size()]));
  }
